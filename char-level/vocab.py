...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        sow, eow = self.start_of_word, self.end_of_word
        return [[[sow, *[self.char2id[c] for c in w], eow] for w in s] for s in sents]
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        sent_char_indices_pad = pad_sents_char(sent_char_indices, self.char2id['<pad>'])
